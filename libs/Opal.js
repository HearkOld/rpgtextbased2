    ...
    Opal.append_features = function(module, klass) {
        ...
        for (var i = 0, length = methods.length; i < length; i++) {
            var method = methods[i],
                current;
            if (prototype.hasOwnProperty(method) && !(current = prototype[method]).$$donated && !current.$$stub) {} else {
    ...
    function define_module_method(module, jsid, body) {
        ...
        if (included_in) {
            for (var i = 0, length = included_in.length; i < length; i++) {
                ...
                if (dest.hasOwnProperty(jsid) && !current.$$donated && !current.$$stub) {} else if (dest.hasOwnProperty(jsid) && !current.$$stub) {
    ...
    (function(Opal) {
        ...
        function load(path) {
            ...
            if (module) {
                ...
                if (severity === "error") {
                    Opal.LoadError ? Opal.LoadError.$new(message) : function() {
                        throw message
                    }()
...
Opal.modules["corelib/helpers"] = function(Opal) {
    ...
    return function($base) {
        ...
        Opal.defs(self, "$coerce_to", function(object, type, method) {
            ...
            if (($a = object["$respond_to?"](method)) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
        ...
        Opal.defs(self, "$coerce_to!", function(object, type, method) {
            ...
            if (($a = type["$==="](coerced)) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
...
Opal.modules["corelib/module"] = function(Opal) {
    ...
    return function($base, $super) {
        ...
        def.$class_variable_get = function(name) {
            ...
            (function() {
                if (($a = value == null) !== nil && (!$a.$$is_boolean || $a == true)) {
        ...
        def["$const_defined?"] = function(name, inherit) {
            ...
            if (($a = name["$=~"](/^[A-Z]\w*$/)) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
        ...
        def.$const_get = function(name, inherit) {
            ...
            if (($a = ($b = name["$[]"]("::"), $b !== false && $b !== nil ? name["$=="]("::")["$!"]() : $b)) !== nil && (!$a.$$is_boolean || $a == true)) {
                return ($a = ($b = name.$split("::")).$inject, $a.$$p = (TMP_2 = function(o, c) {
                    var self = TMP_2.$$s || this;
                    if (o == null) o = nil;
                    if (c == null) c = nil;
                    return o.$const_get(c)
                }, TMP_2.$$s = self, TMP_2), $a).call($b, self)
            }
            if (($a = name["$=~"](/^[A-Z]\w*$/)) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
                self.$raise($scope.get("NameError"), "wrong constant name " + name)
            }
        ...
        def.$define_method = TMP_3 = function(name, method) {
            ...
            }($a = block) !== false && $a !== nil ? $a : block = function() {
                $case = method;
                if ($scope.get("Proc")["$==="]($case)) {
                    return method
                } else if ($scope.get("Method")["$==="]($case)) {
                    return method.$to_proc()
                } else if ($scope.get("UnboundMethod")["$==="]($case)) {
                    return ($b = ($c = self).$lambda, $b.$$p = (TMP_4 = function(args) {
                        var self = TMP_4.$$s || this,
                            $a, bound = nil;
                        args = $slice.call(arguments, 0);
                        bound = method.$bind(self);
                        return ($a = bound).$call.apply($a, [].concat(args))
                    }, TMP_4.$$s = self, TMP_4), $b).call($c)
                } else {
                    return self.$raise($scope.get("TypeError"), "wrong argument type " + block.$class() + " (expected Proc/Method)")
                }
            }();
            var id = "$" + name;
            block.$$jsid = name;
...
Opal.modules["corelib/basic_object"] = function(Opal) {
    ...
    return function($base, $super) {
        ...
        return (Opal.defn(self, "$method_missing", TMP_4 = function(symbol, args) {
            ...
            args = $slice.call(arguments, 1);
            TMP_4.$$p = null;
            return $scope.get("Kernel").$raise($scope.get("NoMethodError"), function() {
                if (($a = self.$inspect && !self.$inspect.$$stub) !== nil && (!$a.$$is_boolean || $a == true)) {
...
Opal.modules["corelib/kernel"] = function(Opal) {
    ...
    return function($base) {
        ...
        var def = self.$$proto,
            $scope = self.$$scope,
            TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_9;
        ...
        Opal.defn(self, "$format", function(format_string, args) {
            ...
            if (($a = ($b = args.$length()["$=="](1)) ? args["$[]"](0)["$respond_to?"]("to_ary") : $b) !== nil && (!$a.$$is_boolean || $a == true)) {
                ...
                if (($a = ary["$nil?"]()) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
                    args = ary.$to_a()
                }
            }
            var result = "",
                begin_slice = 0,
                end_slice, i, len = format_string.length,
                arg, str, exponent, width, precision, tmp_num, hash_parameter_key, closing_brace_char, base_number, base_prefix, base_neg_zero_regex, base_neg_zero_digit, next_arg, seq_arg_num = 1,
                pos_arg_num = 0,
                flags, FNONE = 0,
                FSHARP = 1,
                FMINUS = 2,
            ...
            function CHECK_FOR_FLAGS() {
                if (flags & FWIDTH) {
                    self.$raise($scope.get("ArgumentError"), "flag after width")
                }
                if (flags & FPREC0) {
                    self.$raise($scope.get("ArgumentError"), "flag after precision")
                }
            }

            function CHECK_FOR_WIDTH() {
                if (flags & FWIDTH) {
                    self.$raise($scope.get("ArgumentError"), "width given twice")
                }
                if (flags & FPREC0) {
                    self.$raise($scope.get("ArgumentError"), "width after precision")
                }
            }

            function GET_NTH_ARG(num) {
                if (num >= args.length) {
                    self.$raise($scope.get("ArgumentError"), "too few arguments")
                }
                return args[num]
            }
            ...
            function GET_NEXT_ARG() {
                switch (pos_arg_num) {
                    case -1:
                        self.$raise($scope.get("ArgumentError"), "unnumbered(" + seq_arg_num + ") mixed with numbered");
                    case -2:
                        self.$raise($scope.get("ArgumentError"), "unnumbered(" + seq_arg_num + ") mixed with named")
                }
        ...
        Opal.defn(self, "$p", function(args) {
            ...
            args = $slice.call(arguments, 0);
            ($a = ($b = args).$each, $a.$$p = (TMP_8 = function(obj) {
                var self = TMP_8.$$s || this;
                if ($gvars.stdout == null) $gvars.stdout = nil;
                if (obj == null) obj = nil;
        ...
        Opal.defn(self, "$rand", function(max) {
            ...
            if (max === undefined) {
                ...
                return Math.floor(Math.random() * Math.abs($scope.get("Opal").$coerce_to(max, $scope.get("Integer"), "to_int")))
            }
        });
    ...
    return function($base) {
        ...
        Opal.defn(self, "$==", function(other) {
            ...
            try {
                ...
                if (($a = cmp = self["$<=>"](other)) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
                    return false
                }
...
Opal.modules["corelib/enumerable"] = function(Opal) {
    ...
    return function($base) {
        ...
        var def = self.$$proto,
            $scope = self.$$scope,
            TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_7, TMP_8, TMP_9, TMP_10, TMP_11, TMP_12, TMP_13, TMP_14, TMP_15, TMP_16, TMP_17, TMP_18, TMP_19, TMP_20, TMP_22, TMP_23, TMP_24, TMP_25, TMP_26, TMP_27, TMP_28, TMP_29, TMP_30, TMP_31, TMP_32, TMP_33, TMP_35, TMP_37, TMP_41, TMP_42;
        ...
        Opal.defn(self, "$collect_concat", TMP_5 = function() {
            ...
            return ($a = ($b = self).$map, $a.$$p = (TMP_6 = function(item) {
                var self = TMP_6.$$s || this,
                    $a;
                if (item == null) item = nil;
                return $a = Opal.yield1(block, item), $a === $breaker ? $a : $a
            }, TMP_6.$$s = self, TMP_6), $a).call($b).$flatten(1)
        });
        ...
        Opal.defn(self, "$cycle", TMP_8 = function(n) {
            ...
            if (($a = n["$nil?"]()) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
        ...
        Opal.defn(self, "$lazy", function() {
            ...
            return ($a = ($b = $scope.get("Enumerator").$$scope.get("Lazy")).$new, $a.$$p = (TMP_21 = function(enum$, args) {
                var self = TMP_21.$$s || this,
                    $a;
                if (enum$ == null) enum$ = nil;
                args = $slice.call(arguments, 1);
                return ($a = enum$).$yield.apply($a, [].concat(args))
            }, TMP_21.$$s = self, TMP_21), $a).call($b, self, self.$enumerator_size())
        });
        ...
        Opal.defn(self, "$slice_before", TMP_33 = function(pattern) {
            ...
            return ($a = ($b = $scope.get("Enumerator")).$new, $a.$$p = (TMP_34 = function(e) {
                var self = TMP_34.$$s || this,
                    $a;
                if (e == null) e = nil;
                var slice = [];
                if (block !== nil) {
        ...
        Opal.defn(self, "$sort", TMP_35 = function() {
            ...
            ary = self.$to_a();
            if (block !== nil) {} else {
                block = ($a = ($b = self).$lambda,
                    $a.$$p = (TMP_36 = function(a, b) {
                        var self = TMP_36.$$s || this;
                        if (a == null) a = nil;
                        if (b == null) b = nil;
                        return a["$<=>"](b)
        ...
        Opal.defn(self, "$sort_by", TMP_37 = function() {
            var $a, $b, TMP_38, $c, $d, TMP_39, $e, $f, TMP_40, self = this,
                $iter = TMP_37.$$p,
                block = $iter || nil;
            TMP_37.$$p = null;
            if (block !== nil) {} else {
            ...
            return ($a = ($b = ($c = ($d = ($e = ($f = self).$map, $e.$$p = (TMP_40 = function() {
                var self = TMP_40.$$s || this,
                    arg = nil;
                arg = $scope.get("Opal").$destructure(arguments);
                return [block.$call(arg), arg]
            }, TMP_40.$$s = self, TMP_40), $e).call($f)).$sort, $c.$$p = (TMP_39 = function(a, b) {
                var self = TMP_39.$$s || this;
                if (a == null) a = nil;
                if (b == null) b = nil;
                return a["$[]"](0)["$<=>"](b["$[]"](0))
            }, TMP_39.$$s = self, TMP_39), $c).call($d)).$map, $a.$$p = (TMP_38 = function(arg) {
                var self = TMP_38.$$s || this;
                if (arg == null) arg = nil;
                return arg[1]
...
Opal.modules["corelib/enumerator"] = function(Opal) {
    ...
    return function($base, $super) {
        ...
        def.$inspect = function() {
            ...
            if (($a = self.args["$empty?"]()) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
        ...
        return function($base, $super) {
            ...
            var def = self.$$proto,
                $scope = self.$$scope,
                TMP_8, TMP_11, TMP_13, TMP_18, TMP_20, TMP_21, TMP_23, TMP_26, TMP_29;
            def.enumerator = nil;
            (function($base, $super) {
            ...
            def.$initialize = TMP_8 = function(object, size) {
                ...
                return Opal.find_super_dispatcher(self, "initialize", TMP_8, (TMP_9 = function(yielder, each_args) {
                    var self = TMP_9.$$s || this,
                        $a, $b, TMP_10;
                    if (yielder == null) yielder = nil;
                    each_args = $slice.call(arguments, 1);
                    try {
                        return ($a = ($b = object).$each, $a.$$p = (TMP_10 = function(args) {
            ...
            def.$collect = TMP_11 = function() {
                ...
                return ($a = ($b = $scope.get("Lazy")).$new, $a.$$p = (TMP_12 = function(enum$, args) {
            ...
            def.$collect_concat = TMP_13 = function() {
                ...
                return ($a = ($b = $scope.get("Lazy")).$new, $a.$$p = (TMP_14 = function(enum$, args) {
                    var self = TMP_14.$$s || this,
                        $a, $b, TMP_15, $c, TMP_16;
                    if (enum$ == null) enum$ = nil;
                    args = $slice.call(arguments, 1);
                    var value = Opal.yieldX(block, args);
                    ...
                    if (value["$respond_to?"]("force") && value["$respond_to?"]("each")) {
                        ($a = ($b = value).$each, $a.$$p = (TMP_15 = function(v) {
                            var self = TMP_15.$$s || this;
                            if (v == null) v = nil;
                            return enum$.$yield(v)
                        ...
                        if (array === nil) {
                            ...
                            ($a = ($c = value).$each, $a.$$p = (TMP_16 = function(v) {
                                var self = TMP_16.$$s || this;
                                if (v == null) v = nil;
                                return enum$.$yield(v)
            ...
            def.$drop = function(n) {
                ...
                set_size = function() {
                    if (($a = $scope.get("Integer")["$==="](current_size)) !== nil && (!$a.$$is_boolean || $a == true)) {
                ...
                dropped = 0;
                return ($a = ($b = $scope.get("Lazy")).$new, $a.$$p = (TMP_17 = function(enum$, args) {
                    var self = TMP_17.$$s || this,
                        $a;
                    if (enum$ == null) enum$ = nil;
                    args = $slice.call(arguments, 1);
                    if ($rb_lt(dropped, n)) {
            ...
            def.$drop_while = TMP_18 = function() {
                ...
                succeeding = true;
                return ($a = ($b = $scope.get("Lazy")).$new, $a.$$p = (TMP_19 = function(enum$, args) {
                    var self = TMP_19.$$s || this,
                        $a, $b;
                    if (enum$ == null) enum$ = nil;
                    args = $slice.call(arguments, 1);
            ...
            def.$find_all = TMP_21 = function() {
                ...
                return ($a = ($b = $scope.get("Lazy")).$new, $a.$$p = (TMP_22 = function(enum$, args) {
                    var self = TMP_22.$$s || this,
                        $a;
                    if (enum$ == null) enum$ = nil;
                    args = $slice.call(arguments, 1);
                    var value = Opal.yieldX(block, args);
            ...
            def.$grep = TMP_23 = function(pattern) {
                ...
                TMP_23.$$p = null;
                if (block !== false && block !== nil) {
                    return ($a = ($b = $scope.get("Lazy")).$new, $a.$$p = (TMP_24 = function(enum$, args) {
                        var self = TMP_24.$$s || this,
                            $a;
                        if (enum$ == null) enum$ = nil;
                        args = $slice.call(arguments, 1);
                    ...
                    return ($a = ($c = $scope.get("Lazy")).$new, $a.$$p = (TMP_25 = function(enum$, args) {
                        var self = TMP_25.$$s || this,
                            $a;
                        if (enum$ == null) enum$ = nil;
                        args = $slice.call(arguments, 1);
                        var param = $scope.get("Opal").$destructure(args),
            ...
            def.$reject = TMP_26 = function() {
                ...
                return ($a = ($b = $scope.get("Lazy")).$new, $a.$$p = (TMP_27 = function(enum$, args) {
                    var self = TMP_27.$$s || this,
                        $a;
                    if (enum$ == null) enum$ = nil;
                    args = $slice.call(arguments, 1);
                    var value = Opal.yieldX(block, args);
            ...
            def.$take = function(n) {
                ...
                taken = 0;
                return ($a = ($b = $scope.get("Lazy")).$new, $a.$$p = (TMP_28 = function(enum$, args) {
                    var self = TMP_28.$$s || this,
                        $a;
                    if (enum$ == null) enum$ = nil;
                    args = $slice.call(arguments, 1);
                    if ($rb_lt(taken, n)) {
            ...
            def.$take_while = TMP_29 = function() {
                ...
                return ($a = ($b = $scope.get("Lazy")).$new, $a.$$p = (TMP_30 = function(enum$, args) {
                    var self = TMP_30.$$s || this,
                        $a;
                    if (enum$ == null) enum$ = nil;
                    args = $slice.call(arguments, 1);
                    var value = Opal.yieldX(block, args);
...
Opal.modules["corelib/array"] = function(Opal) {
    ...
    return function($base, $super) {
        ...
        var def = self.$$proto,
            $scope = self.$$scope,
            TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9, TMP_10, TMP_11, TMP_12, TMP_13, TMP_14, TMP_15, TMP_16, TMP_17, TMP_18, TMP_19, TMP_21, TMP_22, TMP_23, TMP_24, TMP_25, TMP_30;
        def.length = nil;
        self.$include($scope.get("Enumerable"));
        def.$$is_array = true;
        ...
        def["$*"] = function(other) {
            ...
            if (($a = other["$respond_to?"]("to_int")) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
        ...
        def.$fill = TMP_12 = function(args) {
            ...
            if (($a = $scope.get("Range")["$==="](one)) !== nil && (!$a.$$is_boolean || $a == true)) {
                ...
                if (($a = one["$exclude_end?"]()) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
                    right += 1
                }
        ...
        def.$sample = function(n) {
            ...
            if (n !== false && n !== nil) {
                return ($a = ($b = $range(1, n, false)).$map, $a.$$p = (TMP_20 = function() {
                    var self = TMP_20.$$s || this;
        ...
        def.$sort = TMP_23 = function() {
            var $a, self = this,
                ...
                block = $iter || nil;
            TMP_23.$$p = null;
            if (($a = self.length > 1) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
                return self
            }
            if (!(block !== nil)) {
                block = function(a, b) {
        ...
        def.$transpose = function() {
            ...
            result = [];
            max = nil;
            ($a = ($b = self).$each, $a.$$p = (TMP_26 = function(row) {
                var self = TMP_26.$$s || this,
                    $a, $b, TMP_27;
                if (row == null) row = nil;
                ...
                return ($a = ($b = row.length).$times, $a.$$p = (TMP_27 = function(i) {
                    var self = TMP_27.$$s || this,
                        $a, $b, $c, entry = nil;
                    if (i == null) i = nil;
        ...
        def.$values_at = function(args) {
            ...
            args = $slice.call(arguments, 0);
            out = [];
            ($a = ($b = args).$each, $a.$$p = (TMP_28 = function(elem) {
                var self = TMP_28.$$s || this,
                    $a, $b, TMP_29, finish = nil,
                    start = nil,
                    i = nil;
                ...
                if (($a = elem["$kind_of?"]($scope.get("Range"))) !== nil && (!$a.$$is_boolean || $a == true)) {
                    ...
                    return ($a = ($b = start).$upto, $a.$$p = (TMP_29 = function(i) {
                        var self = TMP_29.$$s || this;
                        if (i == null) i = nil;
                        return out["$<<"](self.$at(i))
                    }, TMP_29.$$s = self, TMP_29), $a).call($b, finish)
                } else {
...
Opal.modules["corelib/array/inheritance"] = function(Opal) {
    ...
    return function($base, $super) {
        ...
        def["$respond_to?"] = TMP_5 = function(name) {
            var $zuper = $slice.call(arguments, 0);
            var $a, self = this,
                $iter = TMP_5.$$p,
                $yield = $iter || nil;
            TMP_5.$$p = null;
...
Opal.modules["corelib/hash"] = function(Opal) {
    ...
    return function($base, $super) {
        ...
        var def = self.$$proto,
            $scope = self.$$scope,
            TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9, TMP_10, TMP_11, TMP_12, TMP_13;
        ...
        def["$[]"] = function(key) {
            ...
            if (map === undefined) {
                console.log(self, "[] --> key:", key, khash, map)
            }
        ...
        def.$merge = TMP_9 = function(other) {
            var $a, $b, self = this,
                ...
                cloned = nil;
            TMP_9.$$p = null;
            if (($a = $scope.get("Hash")["$==="](other)) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
...
Opal.modules["corelib/string"] = function(Opal) {
    ...
    (function($base, $super) {
        ...
        var def = self.$$proto,
            $scope = self.$$scope,
            TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_10;
        def.length = nil;
        ...
        def["$include?"] = function(other) {
            ...
            if (($a = other["$respond_to?"]("to_str")) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
        ...
        def.$match = TMP_6 = function(pattern, pos) {
            ...
            if (($a = $scope.get("Regexp")["$==="](pattern)) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
        ...
        def.$partition = function(sep) {
            ...
            return [self.slice(0, i), self.slice(i, i + sep.length), self.slice(i + sep.length)]
        };
        def.$reverse = function() {
            var self = this;
            ...
            replacement = replacement.replace(/([\\]+)([0-9+&`'])/g, function(original, slashes, command) {
                ...
                switch (command) {
                    case "+":
                        ...
                        return "";
                    case "&":
                        return slashes.slice(1) + result[0];
                    case "`":
                        return slashes.slice(1) + self.slice(0, result.index);
                    case "'":
                        return slashes.slice(1) + self.slice(result.index + result[0].length);
                    default:
                        return slashes.slice(1) + (result[command] || "")
                }
            }).replace(/\\\\/g, "\\");
        ...
        def.$to_i = function(base) {
            ...
            var result, string = self.toLowerCase(),
        ...
        def.$to_proc = function() {
            var $a, $b, TMP_9, self = this,
                sym = nil;
            sym = self;
            return ($a = ($b = self).$proc, $a.$$p = (TMP_9 = function(args) {
                var self = TMP_9.$$s || this,
                    block, $a, $b, obj = nil;
                args = $slice.call(arguments, 0);
                ...
                obj = args.$shift();
                return ($a = ($b = obj).$__send__, $a.$$p = block.$to_proc(), $a).apply($b, [sym].concat(args))
        ...
        function char_class_from_char_sets(sets) {
            function explode_sequences_in_character_set(set) {
                var result = "",
                    i, len = set.length,
                    curr_char, skip_next_dash, char_code_from, char_code_upto, char_code;
                for (i = 0; i < len; i++) {
            ...
            var i, len, set, neg, chr, tmp, pos_intersection = "",
                neg_intersection = "";
...
Opal.modules["corelib/string/inheritance"] = function(Opal) {
    ...
    return function($base, $super) {
        ...
        var def = self.$$proto,
            $scope = self.$$scope,
            TMP_1, TMP_2, TMP_3, TMP_4, TMP_6, TMP_8;
        def.literal = nil;
        def.$$is_string = true;
        ...
        def["$respond_to?"] = TMP_4 = function(name) {
            var $zuper = $slice.call(arguments, 0);
            var $a, self = this,
                $iter = TMP_4.$$p,
                $yield = $iter || nil;
        ...
        def.$split = function(pattern, limit) {
            ...
            return ($a = ($b = self.literal.$split(pattern, limit)).$map, $a.$$p = (TMP_5 = function(str) {
                var self = TMP_5.$$s || this;
                if (str == null) str = nil;
                return self.$class().$allocate(str)
        ...
        def.$each_line = TMP_6 = function(separator) {
            ...
            return ($a = ($b = self.literal).$each_line, $a.$$p = (TMP_7 = function(str) {
                var self = TMP_7.$$s || this,
                    $a;
                if (str == null) str = nil;
                return $a = Opal.yield1($yield, self.$class().$allocate(str)), $a === $breaker ? $a : $a
            }, TMP_7.$$s = self, TMP_7), $a).call($b, separator)
        };
...
Opal.modules["corelib/match_data"] = function(Opal) {
    ...
    return function($base, $super) {
        ...
        def["$=="] = function(other) {
            ...
            if (($a = $scope.get("MatchData")["$==="](other)) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
                return false
            }
...
Opal.modules["corelib/numeric"] = function(Opal) {
    ...
    (function($base, $super) {
            ...
            try {
                ...
                if (true) {
                    return function() {
                        $case = type;
                        if ("operation" ["$==="]($case)) {
                            return self.$raise($scope.get("TypeError"), "" + other.$class() + " can't be coerced into Numeric")
                        } else if ("comparison" ["$==="]($case)) {
                            return self.$raise($scope.get("ArgumentError"), "comparison of " + self.$class() + " with " + other.$class() + " failed")
                        } else {
                            return nil
                        }
                    }()
        ...
        def.$gcd = function(other) {
            var $a, self = this;
            if (($a = $scope.get("Integer")["$==="](other)) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
        ...
        Opal.defn(self, "$kind_of?", def["$is_a?"]);
        def["$instance_of?"] = TMP_3 = function(klass) {
            var $zuper = $slice.call(arguments, 0);
            var $a, $b, self = this,
                $iter = TMP_3.$$p,
                $yield = $iter || nil;
    ...
    return function($base, $super) {
        ...
        if (($a = typeof Number.EPSILON !== "undefined") !== nil && (!$a.$$is_boolean || $a == true)) {
            ...
            return Opal.cdecl($scope, "EPSILON", 2.220446049250313e-16)
        }
    }(self, $scope.get("Numeric"))
};
...
Opal.modules["corelib/range"] = function(Opal) {
    ...
    return function($base, $super) {
        ...
        def.$initialize = function(first, last, exclude) {
            ...
            if (($a = first["$<=>"](last)) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
                self.$raise($scope.get("ArgumentError"))
            }
            self.begin = first;
            self.end = last;
        ...
        def["$cover?"] = function(value) {
            var $a, $b, self = this;
            return ($a = $rb_le(self.begin, value)) ? function() {
                if (($b = self.exclude) !== nil && (!$b.$$is_boolean || $b == true)) {
        ...
        def["$eql?"] = function(other) {
            var $a, $b, self = this;
            if (($a = $scope.get("Range")["$==="](other)) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
                return false
            }
        ...
        def.$size = function() {
            ...
            if (($a = ($b = $scope.get("Numeric")["$==="](_begin), $b !== false && $b !== nil ? $scope.get("Numeric")["$==="](_end) : $b)) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
                return nil
            }
...
Opal.modules["corelib/time"] = function(Opal) {
    ...
    return function($base, $super) {
        ...
        Opal.defs(self, "$at", function(seconds, frac) {
            ...
            return new Date(seconds * 1e3 + frac)
        });
        ...
        Opal.defs(self, "$local", function(year, month, day, hour, minute, second, millisecond) {
            ...
            year = function() {
                if (($a = year["$kind_of?"]($scope.get("String"))) !== nil && (!$a.$$is_boolean || $a == true)) {
                    return year.$to_i()
                } else {
            ...
            month = function() {
                if (($a = month["$kind_of?"]($scope.get("String"))) !== nil && (!$a.$$is_boolean || $a == true)) {
                    return month.$to_i()
                } else {
            ...
            if (($a = month["$between?"](1, 12)) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
                self.$raise($scope.get("ArgumentError"), "month out of range: " + month)
            }
            day = function() {
                if (($a = day["$kind_of?"]($scope.get("String"))) !== nil && (!$a.$$is_boolean || $a == true)) {
                    return day.$to_i()
                } else {
            ...
            if (($a = day["$between?"](1, 31)) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
                self.$raise($scope.get("ArgumentError"), "day out of range: " + day)
            }
            hour = function() {
                if (($a = hour["$kind_of?"]($scope.get("String"))) !== nil && (!$a.$$is_boolean || $a == true)) {
                    return hour.$to_i()
                } else {
            ...
            if (($a = hour["$between?"](0, 24)) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
                self.$raise($scope.get("ArgumentError"), "hour out of range: " + hour)
            }
            minute = function() {
                if (($a = minute["$kind_of?"]($scope.get("String"))) !== nil && (!$a.$$is_boolean || $a == true)) {
                    return minute.$to_i()
                } else {
            ...
            if (($a = minute["$between?"](0, 59)) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
                self.$raise($scope.get("ArgumentError"), "minute out of range: " + minute)
            }
            second = function() {
                if (($a = second["$kind_of?"]($scope.get("String"))) !== nil && (!$a.$$is_boolean || $a == true)) {
                    return second.$to_i()
                } else {
            ...
            if (($a = second["$between?"](0, 59)) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
        ...
        def["$+"] = function(other) {
            ...
            other = $scope.get("Opal").$coerce_to(other, $scope.get("Integer"), "to_int");
            var result = new Date(self.getTime() + other * 1e3);
        ...
        def["$-"] = function(other) {
            var $a, self = this;
            if (($a = $scope.get("Time")["$==="](other)) !== nil && (!$a.$$is_boolean || $a == true)) {
                return (self.getTime() - other.getTime()) / 1e3
            }
            other = $scope.get("Opal").$coerce_to(other, $scope.get("Integer"), "to_int");
            var result = new Date(self.getTime() - other * 1e3);
            result.tz_offset = self.tz_offset;
        ...
        def.$yday = function() {
            ...
            return Math.ceil((self - onejan) / 864e5)
        };
        def.$isdst = function() {
            var self = this;
            return self.$raise($scope.get("NotImplementedError"))
        ...
        def.$to_f = function() {
            var self = this;
            return self.getTime() / 1e3
        };
        def.$to_i = function() {
            var self = this;
            return parseInt(self.getTime() / 1e3)
        };
        Opal.defn(self, "$to_s", def.$inspect);
        ...
        return (def.$cweek_cyear = function() {
            ...
            week = $rb_divide($rb_plus(self.$yday(), offset), 7).$ceil();
            if ($rb_le(week, 0)) {
...
Opal.modules["corelib/struct"] = function(Opal) {
    ...
    return function($base, $super) {
        ...
        var def = self.$$proto,
            ...
            TMP_1, TMP_6, TMP_8;
        self.$include($scope.get("Enumerable"));
        Opal.defs(self, "$new", TMP_1 = function(name, args) {
            var $zuper = $slice.call(arguments, 0);
            ...
            if (name["$[]"](0)["$=="](name["$[]"](0).$upcase())) {
                ...
                args.$unshift(name);
                return ($b = ($c = $scope.get("Class")).$new, $b.$$p = (TMP_2 = function() {
                    var self = TMP_2.$$s || this,
                        $a, $b, TMP_3, $c;
                    ($a = ($b = args).$each, $a.$$p = (TMP_3 = function(arg) {
        ...
        Opal.defs(self, "$inherited", function(klass) {
            ...
            return ($a = ($b = klass).$instance_eval, $a.$$p = (TMP_4 = function() {
                var self = TMP_4.$$s || this;
        ...
        def.$initialize = function(args) {
            var $a, $b, TMP_5, self = this;
            args = $slice.call(arguments, 0);
            return ($a = ($b = self.$members()).$each_with_index, $a.$$p = (TMP_5 = function(name, index) {
                var self = TMP_5.$$s || this;
        ...
        def["$[]"] = function(name) {
            ...
            if (($a = $scope.get("Integer")["$==="](name)) !== nil && (!$a.$$is_boolean || $a == true)) {
                ...
                if (($a = self.$members()["$include?"](name.$to_sym())) !== nil && (!$a.$$is_boolean || $a == true)) {} else {
        ...
        def.$each = TMP_6 = function() {
            ...
            if ($yield !== nil) {} else {
                return self.$enum_for("each")
            }($a = ($b = self.$members()).$each, $a.$$p = (TMP_7 = function(name) {
                var self = TMP_7.$$s || this,
                    $a;
                if (name == null) name = nil;
        ...
        def.$each_pair = TMP_8 = function() {
            ...
            }($a = ($b = self.$members()).$each, $a.$$p = (TMP_9 = function(name) {
                var self = TMP_9.$$s || this,
                    $a;
                if (name == null) name = nil;
        ...
        def["$eql?"] = function(other) {
            ...
            return ($a = self.$hash()["$=="](other.$hash())) !== false && $a !== nil ? $a : ($b = ($c = other.$each_with_index())["$all?"], $b.$$p = (TMP_10 = function(object, index) {
                var self = TMP_10.$$s || this;
                if (object == null) object = nil;
                if (index == null) index = nil;
                return self["$[]"](self.$members()["$[]"](index))["$=="](object)
            }, TMP_10.$$s = self, TMP_10), $b).call($c)
        };
        def.$length = function() {
            var self = this;
        ...
        def.$to_a = function() {
            ...
            return ($a = ($b = self.$members()).$map, $a.$$p = (TMP_11 = function(name) {
                var self = TMP_11.$$s || this;
                if (name == null) name = nil;
                return self["$[]"](name)
        ...
        def.$inspect = function() {
            ...
            result = $rb_plus(result, ($a = ($b = self.$each_pair()).$map, $a.$$p = (TMP_12 = function(name, value) {
                var self = TMP_12.$$s || this;
                if (name == null) name = nil;
                if (value == null) value = nil;
                return "" + name + "=" + value.$inspect()
            }, TMP_12.$$s = self, TMP_12), $a).call($b).$join(", "));
        ...
        def.$to_h = function() {
            ...
            return ($a = ($b = self.$members()).$inject, $a.$$p = (TMP_13 = function(h, name) {
                var self = TMP_13.$$s || this;
                if (h == null) h = nil;
                if (name == null) name = nil;
                h["$[]="](name, self["$[]"](name));
                return h
            }, TMP_13.$$s = self, TMP_13), $a).call($b, $hash2([], {}))
        };
        return (def.$values_at = function(args) {
            var $a, $b, TMP_14, self = this;
            args = $slice.call(arguments, 0);
            args = ($a = ($b = args).$map, $a.$$p = (TMP_14 = function(arg) {
                var self = TMP_14.$$s || this;
                if (arg == null) arg = nil;
                return arg.$$is_range ? arg.$to_a() : arg
            }, TMP_14.$$s = self, TMP_14), $a).call($b).$flatten();
            var result = [];
...
Opal.modules["corelib/io"] = function(Opal) {
    ...
    (function($base, $super) {
        ...
        (function($base) {
            ...
            Opal.defn(self, "$print", function(args) {
                ...
                if ($gvars[","] == null) $gvars[","] = nil;
                args = $slice.call(arguments, 0);
                self.$write(($a = ($b = args).$map, $a.$$p = (TMP_1 = function(arg) {
                    var self = TMP_1.$$s || this;
                    if (arg == null) arg = nil;
                    return self.$String(arg)
                }, TMP_1.$$s = self, TMP_1), $a).call($b).$join($gvars[","]));
                return nil
            });
            Opal.defn(self, "$puts", function(args) {
                ...
                if (($a = args["$empty?"]()) !== nil && (!$a.$$is_boolean || $a == true)) {
                    ...
                    self.$write(($a = ($b = args).$map, $a.$$p = (TMP_2 = function(arg) {
                        var self = TMP_2.$$s || this;
                        if (arg == null) arg = nil;
                        return self.$String(arg).$chomp()
                    }, TMP_2.$$s = self, TMP_2), $a).call($b).$concat([nil]).$join(newline))
                }
                return nil
            })
        })(self);
    ...
    $a = [typeof process === "object" ? function(s) {
        process.stdout.write(s)
    } : function(s) {
        console.log(s)
    }], $b = $gvars.stdout, $b["$write_proc="].apply($b, $a), $a[$a.length - 1];
    $a = [typeof process === "object" ? function(s) {
        process.stderr.write(s)
    } : function(s) {
        console.warn(s)
    }], $b = $gvars.stderr, $b["$write_proc="].apply($b, $a), $a[$a.length - 1];
    ...
    return function($base, $super) {
        ...
        return function(self) {
            ...
            self.$$proto.$expand_path = function(path, basedir) {
                ...
                }($a = ($b = parts).$each, $a.$$p = (TMP_1 = function(part) {
                    var self = TMP_1.$$s || this;
            ...
            self.$$proto["$directory?"] = function(path) {
                ...
                file = ($a = ($b = files).$find, $a.$$p = (TMP_2 = function(file) {
                    var self = TMP_2.$$s || this;
                    if (file == null) file = nil;
                    return file["$=~"](new RegExp("^" + path))
